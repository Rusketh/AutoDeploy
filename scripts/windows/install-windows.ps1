...
Write-Host "Default shape is HTTP on port 8080; log in at"
Write-Host "    http://<this-host>:8080/portal/"
Write-Host "(or https://<this-host>/portal/ if you configured HTTPS),"
Write-Host "change the password in Settings -> Local accounts, then delete"
Write-Host "the bootstrap file."
Write-Host ""
